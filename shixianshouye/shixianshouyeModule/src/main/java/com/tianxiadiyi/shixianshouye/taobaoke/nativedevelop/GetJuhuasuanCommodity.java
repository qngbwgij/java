...
public class GetJuhuasuanCommodity {
...
//    String url_taobaoke = "http://gw.api.taobao.com/router/rest";
//    String appkey_taobaoke = "32004101";
//    String secret_taobaoke = "da92791334e9128ae7d063d3b389757e";
    ...
    private static final String appKey = "32004101"; // 可替换为您的沙箱环境应用的appKey
    private static final String appSecret = "da92791334e9128ae7d063d3b389757e"; // 可替换为您的沙箱环境应用的appSecret
    ...
    private static String getSellerItem() throws IOException, NoSuchAlgorithmException {
     ...
     * 对TOP请求进行签名。
     */
    private static String signTopRequest(Map<String, String> params, String secret, String signMethod) throws IOException, NoSuchAlgorithmException {
        // 第一步：检查参数是否已经排序
     ...
     * 对字节流进行HMAC_MD5摘要。
     */
    private static byte[] encryptHMAC(String data, String secret) throws IOException, NoSuchAlgorithmException {
        byte[] bytes = null;
        try {
        ...
        //} catch (GeneralSecurityException | NoSuchAlgorithmException gse) {
